...
-- Drop the function and trigger first
DROP TRIGGER IF EXISTS trigger_actualizar_estado_negocio_presupuestos ON public.presupuestos;
DROP FUNCTION IF EXISTS public.trigger_actualizar_estado_negocio();
DROP FUNCTION IF EXISTS public.calcular_estado_negocio(uuid);
