-- ================================================================
-- MIGRACIÓN: CONTACTOS Y MAPEO DE ESTADOS GLOBALES
-- ================================================================

-- 1. ACTUALIZAR TABLA CONTACTOS PARA SER GLOBAL
-- Eliminar la constraint única que incluye user_id para permitir contactos globales
...
-- Crear constraint única por hubspot_id (global) 
