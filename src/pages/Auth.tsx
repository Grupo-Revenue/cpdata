                  ...
                  <form onSubmit={handleSignup} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="nombre" value={signupForm.nombre} onChange={e => setSignupForm({
                      ...signupForm,
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="apellido" value={signupForm.apellido} onChange={e => setSignupForm({
                      ...signupForm,
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="telefono" value={signupForm.telefono} onChange={e => setSignupForm({
                    ...signupForm,
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="empresa" value={signupForm.empresa} onChange={e => setSignupForm({
                    ...signupForm,
