...
import { ArrowLeft, Plus, Edit, Trash2, Building2, User, Calendar, MapPin, Mail, Phone, Loader2, FileText, Download, DollarSign } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            {valorNegocio === 0 && (
              <div className="text-center">
                ...
                <Button 
                  onClick={() => setMostrarCrearPresupuesto(true)} 
                  size="sm"
