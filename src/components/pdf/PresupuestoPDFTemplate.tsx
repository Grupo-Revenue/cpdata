...
const PresupuestoPDFTemplate = React.forwardRef<HTMLDivElement, PresupuestoPDFTemplateProps>(({
  ...
  // Calculate totals with proper IVA breakdown
        ...
        <div className="grid grid-cols-2 gap-8 mb-6">
          ...
          <div className="text-right">
            ...
            <div className="text-sm space-y-1">
              ...
              <p><span className="font-semibold">Forma de Pago:</span> 50% anticipo, 50% contra entrega</p>
              <p><span className="font-semibold">Tiempo de Entrega:</span> 10-15 días hábiles</p>
